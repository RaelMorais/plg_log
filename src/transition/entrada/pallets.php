  ...
  <div class="alert">
    <div class="container">
      ...
      <div class="coluna esquerda">
        ...
        <h6>pallet 1</h6>
        <div class="campos">
          <label class="editavel" id="editavel1">0</label>
          <label> / </label>
        ...
        <h6>pallet 2</h6>
        <div class="campos">
          <label class="editavel" id="editavel2">0</label>
          <label> / </label>
        ...
        <h6>pallet 3</h6>
        <div class="campos">
          <label class="editavel" id="editavel3">0</label>
          <label> / </label>
      ...
      <div class="coluna direita">
        ...
        <h6>pallet 4</h6>
        <div class="campos">
          <label class="editavel" id="editavel4">0</label>
          <label> / </label>
        ...
        <h6>pallet 5</h6>
        <div class="campos">
          <label class="editavel" id="editavel5">0</label>
          <label> / </label>
        ...
        <h6>pallet </h6>
        <div class="campos">
          <label class="editavel" id="editavel6">0</label>
          <label> / </label>
