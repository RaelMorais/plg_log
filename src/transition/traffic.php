...
?>
    ...
    <?php include("entrada/buscaInput.php");?>
    <?php include("saida/buscaExit.php");?>

    <?php include("entrada/sampling_box.php");?>
    <?php include("saida/sampling_box_saida.php");?>
    
    <?php include("entrada/quantificadorEnt.php");?>
    <?php include("saida/quantificadorSaida.php");?>

    <?php include("entrada/pallets.php");?>

    <script src="/assets/js/controleRequests.js"></script>
